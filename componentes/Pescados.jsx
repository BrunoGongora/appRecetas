...
const Pescados = () => {
    ...
    useEffect(() => {
        const getFish = async () => {
            ...
            setPescado(resultado.data.meals)
        }
        getFish();
    }, [])
    ...
    <div>
        <div>
            <div className="recetas_container">
                {
                    pescado.map((pezPlato, index) => {
                        return(
                            <div className="box_receta" key={index}>
                                <img src={pezPlato.strMealThumb} alt="" />
                                <div className="hearth">
                                <button className="nombre_plato" onClick={() => handleClick(pezPlato.idMeal)}>
                                    <h5>{pezPlato.strMeal}</h5>
                                </button>
